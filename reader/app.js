...
import { extractChapterNumber, sortChapterNames, sanitizeChapters } from './chapters.js';
...
import { renderGallery, toggleGallery, attachGalleryButton } from './gallery.js';
import { showControlsBar, onFullscreenChange, toggleFullscreen, handleMouseEnterControls, handleMouseLeaveControls } from './fullscreen.js';
...
(function () {
      ...
      function attachEventHandlers() {
        ...
        if (nextChapterBtn) {
          nextChapterBtn.addEventListener('click', () => goToNextChapter(chapterOrder, chapters));
        }
        if (restartChapterBtn) {
          restartChapterBtn.addEventListener('click', () => restartChapter(chapters));
        }
        if (closeEndOverlay) {
      ...
      function init() {
        ...
        const availableChapters = chapterOrder.length ? chapterOrder : Object.keys(chapters);
